...
/**
   ...
   * @Description: 注册动态数据源 初始化数据源和提供了执行动态切换数据源的工具类 获取配置文件配置的属性值
   */
@Component
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    /**
       * @param:
       * @return:
       * @date: 2018/8/25/025 21:55
       * @auther: TanShuoGuo
       * @Description:  读取配置文件获取更多数据源
       */
